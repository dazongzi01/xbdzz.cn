...
2. 进入crmeb系统后台，点击**设置→系统设置→应用配置→小程序配置**
   ![WEB PC 管理端配置好微信小程序](https://fastly.jsdelivr.net/gh/xbdazz/mypic/img/202203291710438.png)
...
5. **设置管理→系统设置→商城配置→用户充值配置，小程序充值开关，选择“关闭”，提交。**
   ...
   ![WEB PC管理端关闭小程序充值](https://fastly.jsdelivr.net/gh/xbdazz/mypic/img/202203291714676.png)
