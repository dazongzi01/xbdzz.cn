...
![](http://pic.xbdzz.cn/write/202203251547176.png)

安装完毕之后会有如下结果，访问链接和账号密码，需要在对应的服务器安全策略中开启8888端口以便白塔面板可以正确访问。

![](http://pic.xbdzz.cn/write/202203251550776.png)

如上图宝塔安装完毕，接下来找到软件。首次安装网之后会有提示安装也可以手动按安装。

![](http://pic.xbdzz.cn/write/202203251552951.png)

如上图安装mysql5.7，redis和nginx。

redis 开启远程登录和守护模式启动

![](http://pic.xbdzz.cn/write/202203251554327.png)

![](http://pic.xbdzz.cn/write/202203251556212.png)

![](http://pic.xbdzz.cn/write/202203251557834.png)
...
![](http://pic.xbdzz.cn/write/202203251619743.png)

### 确定运行环境正确

根据自己的服务地址在桌面程序中配置链接，确认链接成功。

![](http://pic.xbdzz.cn/write/202203251629791.png)

**redis链接成功**

在宝塔上创建数据库，链接方式根据自己需求选择，只有开启远程的情况下mysql桌面客户端才能正确链接得上。线上可以安装php插件phpMyAdmin实现在线查看数据库。一般不建议生产环境使用。

![](http://pic.xbdzz.cn/write/202203251632761.png)

![](http://pic.xbdzz.cn/write/202203251633220.png)
...
![](http://pic.xbdzz.cn/write/202203251712911.png)

远程链接SSH 客户端执行 java -version  ssh 客户端链接是服务商提供的，去平台获取或者自己设置就好。

![](http://pic.xbdzz.cn/write/202203251715696.png)
