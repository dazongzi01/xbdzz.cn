...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "西北大粽子",
      description: 'web全栈技术博客,在被业务的这么下还能留下点什么。JS,ES6,TypeScript,vue,Java等全栈web开发总结和记录。',
    }
  },
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: 'CRMEB',
        link: '/crmebjava/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
        items: [
    ...
    repo: 'xbdazz/xbdzz.cn', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '大粽子', // 必需
      link: 'https://github.com/xbdazz', // 可选的
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'WEB全栈,博客,个人技术博客,Java,前端,技术文档,学习,面试,JS,ES6,vue,,Node,git,Springboot',
      },
    ],
  ...
  plugins: <UserPlugins>[
    ...
    'thirdparty-search', {
      thirdparty: [
        ...
        {
          title: '通过百度搜索本站的',
          frontUrl: 'https://www.baidu.com/s?wd=site%3xbdzz.cn%20',
        },
      ],
    },
